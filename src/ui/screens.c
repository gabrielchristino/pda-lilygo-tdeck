...
static void event_handler_cb_calculator_obj6(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_calculator_obj7(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_calculator_obj8(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_calendar_events_list_obj36(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_calendar_events_list_obj26(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_calendar_events_list_obj27(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_calendar_events_list_obj28(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
void create_screen_calculator() {
    ...
    lv_obj_set_size(obj, 320, 240);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_calculator_obj6, LV_EVENT_ALL, flowState);
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 70, 26);
            lv_obj_add_event_cb(obj, event_handler_cb_calculator_obj7, LV_EVENT_ALL, flowState);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff72766e), LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 70, 26);
            lv_obj_add_event_cb(obj, event_handler_cb_calculator_obj8, LV_EVENT_ALL, flowState);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff72766e), LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
...
void create_screen_calendar_new_event() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xfffffef7), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_loading_screen(obj, getFlowState(flowState, 14), 19);
        }
    }
...
void tick_screen_calendar_new_event() {
    ...
    tick_user_widget_loading_screen(getFlowState(flowState, 14), 19);
}
...
void create_screen_calendar_events_list() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xfffffef7), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_calendar_events_list_obj36, LV_EVENT_ALL, flowState);
        }
        {
            lv_obj_t *obj = lv_btn_create(parent_obj);
            objects.obj26 = obj;
            ...
            lv_obj_set_size(obj, 96, 32);
            lv_obj_add_event_cb(obj, event_handler_cb_calendar_events_list_obj26, LV_EVENT_ALL, flowState);
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 96, 32);
            lv_obj_add_event_cb(obj, event_handler_cb_calendar_events_list_obj27, LV_EVENT_ALL, flowState);
            {
                lv_obj_t *parent_obj = obj;
                {
                    lv_obj_t *obj = lv_label_create(parent_obj);
        ...
        }
        {
            ...
            lv_obj_set_scrollbar_mode(obj, LV_SCROLLBAR_MODE_OFF);
            {
                ...
                }
                {
                    ...
                    lv_obj_set_size(obj, 96, 32);
                    lv_obj_add_event_cb(obj, event_handler_cb_calendar_events_list_obj28, LV_EVENT_ALL, flowState);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            lv_obj_t *obj = lv_label_create(parent_obj);
...
void tick_screen_calendar_events_list() {
    ...
    tick_user_widget_loading_screen(getFlowState(flowState, 2), 25);
    {
        ...
        const char *cur_val = lv_roller_get_options(objects.obj36);
        if (compareRollerOptions((lv_roller_t *)objects.obj36, new_val, cur_val, LV_ROLLER_MODE_NORMAL) != 0) {
            tick_value_change_obj = objects.obj36;
            lv_roller_set_options(objects.obj36, new_val, LV_ROLLER_MODE_NORMAL);
            tick_value_change_obj = NULL;
        }
    }
    {
        if (!(lv_obj_get_state(objects.obj36) & LV_STATE_EDITED)) {
            int32_t new_val = evalIntegerProperty(flowState, 3, 4, "Failed to evaluate Selected in Roller widget");
            int32_t cur_val = lv_roller_get_selected(objects.obj36);
            if (new_val != cur_val) {
                tick_value_change_obj = objects.obj36;
                lv_roller_set_selected(objects.obj36, new_val, LV_ANIM_OFF);
                tick_value_change_obj = NULL;
            }
        }
    }
...
static const char *object_names[] = { "main", "calculator", "calendar", "calendar_new_event", "calendar_events_list", "tasks", "obj0", "obj0__obj0", "obj0__obj1", "obj0__obj2", "obj1", "obj1__obj0", "obj1__obj1", "obj1__obj2", "obj2", "obj2__obj0", "obj2__obj1", "obj2__obj2", "is_loading", "is_loading__obj3", "obj3", "obj3__obj0", "obj3__obj1", "obj3__obj2", "obj4", "obj4__obj3", "obj5", "obj5__obj0", "obj5__obj1", "obj5__obj2", "btn_calculator", "btn_calendar", "btn_tasks", "obj6", "obj7", "obj8", "obj9", "obj10", "obj11", "obj12", "obj13", "obj14", "obj15", "obj16", "obj17", "obj18", "obj19", "obj20", "obj21", "obj22", "obj23", "obj24", "obj25", "cal_calendar", "btn_save", "obj26", "obj27", "obj28", "obj29", "lbl_main_clock", "lbl_main_date", "txt_calc", "obj30", "obj31", "obj32", "obj33", "obj34", "txt_event_name", "start_hour", "start_minute", "lbl_from", "end_hour", "end_minute", "lbl_to", "keyboard", "obj35", "obj36", "msgbox_noevents", "obj37", "obj38", "obj39", "obj40" };
